...
export default function Home() {
  ...
  const handleSendChat = useCallback(
    async (text: string) => {
      //remove OpenAikey error message
      /*if (!openAiKey) {
      ...
      const response = await getChatResponse(messages, openAiKey).catch((e) => {
        console.error(e);
        return { message: "" };
      });
    ...
    [systemPrompt, chatLog, openAiKey]
  );
